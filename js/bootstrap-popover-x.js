/* forked from Kartik version, make it work with newer jQuery and meet our needs */
/*!
...
;(function ($) {
  ...
  $(function() {
    $(document).off('click.modal').on('click.modal.data-api', '[data-toggle="popover-x"]', function (e) {
